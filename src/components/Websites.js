    ...
    <View>
      <View style={styles.container}>
        ...
        >
          ...
          />
          <Text style={styles.text} selectable={true}>Eternity Band</Text>
          <Feather
            name="external-link"
            size={21}
            color="black"
        ...
        >
          ...
          />
          <Text style={styles.text} selectable={true}>Audacity Workshop</Text>
          <Feather
            name="external-link"
            size={21}
            color="black"
        ...
        >
          ...
          />
          <Text style={styles.text} selectable={true}>ColorVision</Text>
          <Feather
            name="external-link"
            size={21}
            color="black"
        ...
        >
          ...
          />
          <Text style={styles.text} selectable={true}>FUN Youth</Text>
          <Feather
            name="external-link"
            size={21}
            color="black"
        ...
        >
          ...
          />
          <Text style={styles.text} selectable={true}>Audacity Dance Club</Text>
          <Feather
            name="external-link"
            size={21}
            color="black"
