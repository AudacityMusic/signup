    ...
    <View style={styles.container}>
      ...
      >
        <Entypo
          ...
          style={styles.icon}
        />
        <Text style={styles.text} selectable={true}>Request a Concert</Text>
        <FontAwesome
          name="chevron-right"
          size={20}
          color="black"
      ...
      >
        <MaterialCommunityIcons
          ...
          style={styles.icon}
        />
        <Text style={styles.text} selectable={true}>Sign Up for Audacity Dance Club</Text>
        <FontAwesome
          name="chevron-right"
          size={20}
          color="black"
      ...
      >
        ...
        <Text style={styles.text} selectable={true}>Donate to FUN Youth</Text>
        <Feather
          name="external-link"
          size={21}
          color="black"
